...
public class C08_RelativeLocator {
...
// Locate Canada link using Relative Locator
//        WebElement canadaLinkRela = driver.findElement(RelativeLocator.with(By.tagName("a")).toRightOf(By.xpath("//a[@class='us-link']")));
//        Assertions.assertTrue(canadaLinkRela.getAttribute("class").contains("canada-link"));
//        Assertions.assertTrue(canadaLinkRela.isDisplayed());
